    ...
    def train(self):
        ...
        for step in range(start_iter, self.iteration + 1):
            ...
            if step % self.print_freq == 0:
                ...
                A2B_test = np.zeros((self.img_size * 7, 0, 3))
                B2A_test = np.zeros((self.img_size * 7, 0, 3))
                ...
                for _ in range(test_sample_num):
                    ...
                    A2B_test = np.concatenate((A2B_test, np.concatenate((RGB2BGR(tensor2numpy(denorm(real_A[0]))),
                                                                       cam(tensor2numpy(fake_A2A_heatmap[0]), self.img_size),
                                                                       RGB2BGR(tensor2numpy(denorm(fake_A2A[0]))),
                                                                       cam(tensor2numpy(fake_A2B_heatmap[0]), self.img_size),
                                                                       RGB2BGR(tensor2numpy(denorm(fake_A2B[0]))),
                    ...
                    B2A_test = np.concatenate((B2A_test, np.concatenate((RGB2BGR(tensor2numpy(denorm(real_B[0]))),
                                                                       cam(tensor2numpy(fake_B2B_heatmap[0]), self.img_size),
                                                                       RGB2BGR(tensor2numpy(denorm(fake_B2B[0]))),
                                                                       cam(tensor2numpy(fake_B2A_heatmap[0]), self.img_size),
                                                                       RGB2BGR(tensor2numpy(denorm(fake_B2A[0]))),
                ...
                cv2.imwrite(os.path.join(self.result_dir, self.dataset, 'img', 'A2B_test_%07d.png' % step), A2B_test * 255.0)
                cv2.imwrite(os.path.join(self.result_dir, self.dataset, 'img', 'B2A_test_%07d.png' % step), B2A_test * 255.0)
